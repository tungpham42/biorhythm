...
class UnirestRequest
{
     ...
     * @return Unirest\UnirestResponse
     */
    public static function get($url, $headers = array(), $parameters = null, $username = null, $password = null)
    {
        return self::send(UnirestMethod::GET, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::HEAD, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::OPTIONS, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::CONNECT, $url, $parameters, $headers, $username, $password);
    }
     ...
     * @param string $username Basic Authentication username (deprecated)
     * @param string $password Basic Authentication password (deprecated)
     * @return Unirest\UnirestResponse response
     */
    public static function post($url, $headers = array(), $body = null, $username = null, $password = null)
    {
        return self::send(UnirestMethod::POST, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::DELETE, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::PUT, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::PATCH, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::send(UnirestMethod::TRACE, $url, $body, $headers, $username, $password);
    }
    ...
    /**
     * Send a cURL request
     * @param Unirest\UnirestMethod $method HTTP method to use
    ...
    public static function send($method, $url, $body = null, $headers = array(), $username = null, $password = null)
    {
        ...
        return new UnirestResponse($httpCode, $body, $header, self::$jsonOpts);
    }
