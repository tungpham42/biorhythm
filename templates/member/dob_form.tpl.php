...
<div id="dob_wrapper">
	<form id="dob_form" class="no-select-highlight" action="" method="POST">
		<div class="m-input-prepend" id="dob_bar">
			...
			<input pattern="\d*" tabindex="2" data-lang-ja="<?php echo $input_interfaces['dob']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['dob']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['dob']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['dob']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['dob']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['dob']['vi']; ?>" placeholder="<?php echo $input_interfaces['dob'][$lang_code]; ?>" id="dob" type="text" name="person_dob" size="10" maxlength="128" class="required m-wrap translate" autocomplete="off" spellcheck="false" />
