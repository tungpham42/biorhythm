...
if (strtolower($_SERVER['HTTP_X_REQUESTED_WITH'])=='xmlhttprequest' && isset($_GET['dob']) && isset($_GET['diff']) && isset($_GET['dt_change']) && isset($_GET['partner_dob']) && isset($_GET['lang_code'])) {
