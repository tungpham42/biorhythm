<nav>
	<ul id="nav_buttons">
		...
		<li><a id="forum_link" class="nav_button button" href="http://diendan.nhipsinhhoc.vn"><?php echo translate_button('forum'); ?></a></li>
		<li><a id="lunar_link" class="nav_button button lunar" href="/xemngay/"><?php echo translate_button('lunar'); ?></a></li>
		<li><a id="bmi_link" class="nav_button button bmi" href="/bmi/"><?php echo translate_button('bmi'); ?></a></li>
		...
		<li><a id="game_link" class="nav_button button game" href="/game/"><?php echo translate_button('game'); ?></a></li>
	</ul>
</nav>