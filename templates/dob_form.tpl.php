...
?>
			...
			<input tabindex="2" data-lang-ja="<?php echo $input_interfaces['dob']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['dob']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['dob']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['dob']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['dob']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['dob']['vi']; ?>" placeholder="<?php echo $input_interfaces['dob'][$lang_code]; ?>" id="dob" type="text" name="dob" size="10" maxlength="128" class="required m-wrap translate" <?php echo (isset($_GET['dob']) && $_GET['dob'] != '') ? 'readonly disabled': ''; ?> value="<?php echo (isset($_GET['dob']) && $_GET['dob'] != '') ? date('Y-m-d',strtotime($_GET['dob'])): ''; ?>" autocomplete="off" spellcheck="false" />
